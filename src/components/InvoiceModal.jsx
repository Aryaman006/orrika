...
const OrderSummary = ({ selectedOrder, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-black bg-opacity-50 flex justify-center overflow-y-auto items-center print:items-start">
    {/* <div className="fixed inset-0 z-[1000] bg-black bg-opacity-50 flex items-center justify-center overflow-y-auto"> */}
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl w-full relative printable-area mt-20 print:mt-0 max-h-[90vh] overflow-y-auto">
        <button
          className="absolute top-4 right-4 text-gray-600 hover:text-gray-900 no-print"
          onClick={onClose}
        >
        ...
        <div className="flex flex-col items-center mb-8">
          <img src='/logo3.png' alt="Company Logo" className="w-36 h-auto mb-4 z-[400]" />
        ...
        <div className="mt-6">
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition-colors no-print"
          >
            Print Invoice
          </button>
        </div>
